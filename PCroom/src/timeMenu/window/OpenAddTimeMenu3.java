...
public class OpenAddTimeMenu3 extends JFrame {
    ...
    public OpenAddTimeMenu3(String userId, int remainingSeconds, int useMoney, JTextField textFieldRemainingTime, JTextField textFieldUsageFee, Client client) {
    	this.userId = userId;
    ...
    private void setupBottomButtons(String userId, int timeNum) {
        ...
        payButton.addActionListener(e -> {
            if (selectedAddSeconds > 0 && selectedCost > 0) {
                ...
                String response = client.sendCommand("TIME_PAY," + userId + "," + this.timeNum); // 모든 데이터를 요청
